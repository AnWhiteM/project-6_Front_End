...
import { selectLoading, selectError, selectCurrentBoard, selectBoards } from "../../redux/boards/selectors";
...
export const ScreensPage = () => {
    ...
    return (
        <div className={css.container}>
            ...
            {currentDesk ? <MainDashboard board={currentDesk} /> : <DashboardMessage />}
        </div>
    );
};